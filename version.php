...
$plugin->version   = 2018082408;            // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release   = '3.6.0 (Build 2018082408)';// Required for registering to Moodle's database of plugins.
